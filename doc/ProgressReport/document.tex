...
Detail bagian pekerjaan skripsi sesuai dengan rencan kerja/laporan perkembangan terkahir :
	...
	\paragraph{Pilihan Grid}
		...
		\paragraph{Opsi Tabel dengan \textit{head} yang dimodifikasi} \par
		...
		{\bf Status :} Ada sejak rencana kerja skripsi.\\
		{\bf Hasil :} Sebagian besar sudah diimplementasikan.
		...
		\begin{figure}[ht!]
			\includegraphics [scale=0.5] {home_bootstrap.PNG}
		...
		\begin{figure}[ht!]
			\includegraphics [scale=0.5] {Tampilan-Perubahan-Kuliah_Bootstrap.PNG}
			\caption{Tampilan Perubahan Kuliah dengan Bootstrap}
		\end{figure}
		
		\begin{figure}[ht!]
			\includegraphics [scale=0.5] {Tampilan-Manajemen-Perubahan-Kuliah_Bootstrap.PNG}
			\caption{Tampilan Manajemen Perubahan Kuliah dengan Bootstrap}
		\end{figure}
		...
		\paragraph{Analisis Frontend Library} \par
