...
Menu terdiri dari sebuah \colorbox{mygray}{\texttt{<ul>}} yang diisi oleh beberapa tag \colorbox{mygray}{\texttt{<li>}}. Secara default, menu akan berorientasi horizontal.
...
Secara default, setiap item dalam menu akan berlajur ke arah kiri. Menu dapat diubah lajurnya ke arah kanan dengan menggunakan kelas \colorbox{mygray}{\texttt{.align-right}} atau kearah tengah dengan menambahkan kelas \colorbox{mygray}{\texttt{.align-center}} didalam kelas \colorbox{mygray}{\texttt{.menu}}.
\begin{lstlisting}[frame=single] 
...
Kelas \colorbox{mygray}{\texttt{.is-active}} dapat ditambahkan ke dalam tag \colorbox{mygray}{\texttt{<li>}} untuk membuat menu terpilih yang aktif terlihat saat di klik. 
...
Penggunaan kelas \colorbox{mygray}{\texttt{.table-striped}} akan membuat tabel memiliki warna baris berbeda batas antara baris genap dan ganjil didalam tag \texttt{<tbody>}.
