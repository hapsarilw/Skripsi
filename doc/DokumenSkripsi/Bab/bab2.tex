...
\begin{figure} [H]
	\centering  
	\includegraphics[scale=0.6]{jQuery_closest.png}  
...
Contoh pemakaian metode ini terlihat pada kode ~\ref{lst:contohjQueryClone}: Clone semua elemen \texttt{<p>} dan masukan semua elemen pada akhir elemen \texttt{<body>}.
