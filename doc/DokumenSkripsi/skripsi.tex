...
\definecolor{codecolor}{rgb}{0.14, 0.16, 0.48}
...
\definecolor{codestring}{rgb}{0.4, 0.0, 0.04}
...
\lstdefinestyle{JSES6Base}{
	...
	keywordstyle={[2]\color{byzantium}},
	...
	stringstyle = \color{codestring},
	emphstyle = {\color{forestgreen(traditional)}},
	moredelim=[s][\color{forestgreen(traditional)}]{\$}{\ }
	frame = single
}
...
\lstdefinestyle{customphp}{
	...
	emphstyle       =[2]\color{harvestgold},
	emph			=[3]{class, extends, use, protected, public, namespace, return, function, echo},
	emphstyle       =[3]\bfseries,
	emph			=[4]{html, title, meta, style, head, body,h1},
	emphstyle       =[4]\color{codecolor}
	moredelim=[s][\color{britishracinggreen}]{\$}{\ }	
}
...
\newcommand{\vtext}[3]{\IfStrEq{\vmode}{template}{\newcommand{#1}{\xtxt{#2}#3}}{\newcommand{#1}{#2}}}
\newcommand{\vtextup}[3]{\IfStrEq{\vmode}{template}{\newcommand{#1}{\uppercase{#2}#3}}{\newcommand{#1}{\uppercase{#2}}}}

%default data prodi
\newcommand{\vprodiINA}{<<MATEMATIKA/FISIKA/TEKNIK INFORMATIKA>>}
\newcommand{\vprodiENG}{<<MATHEMATICS/PHYSICS/INFORMATICS>>}
\newcommand{\vstaINA}{<<SKRIPSI/TUGAS AKHIR>>} 
\newcommand{\vstaENG}{<<FINAL PROJECT/UNDERGRADUATE THESIS>>}
...
%data tanggal sidang
\newcommand{\tanggal}[3]{
	\newcommand{\vtanggal}{#1} \IfInteger{#1}{\renewcommand{\vtanggal}{#1}}{}
	\newcommand{\vtahun}{#3} \IfInteger{#3}{\renewcommand{\vtahun}{#3}}{}
	\newcommand{\vbulan}{#2}
