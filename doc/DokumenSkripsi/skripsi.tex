...
\singlespacing%selalu single %listing khusus untuk penulisan kode program, menggunakan font Bera Mono
\lstset{numbers=left,stepnumber=1, numbersep=5pt, frame=leftline,
	...
	literate={-}{-}1{-\,-}{--}1
} %spacing untuk lampiran dan daftar referensi
